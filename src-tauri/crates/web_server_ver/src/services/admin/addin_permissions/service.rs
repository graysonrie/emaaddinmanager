...
use crate::services::{
    admin::addin_permissions::models::user::UserModel, user_stats::{UserStatsService, db::user_addins::UserAddinsTable},
};

pub struct AddinPermissionsService {
    local_stats: Arc<UserStatsService>,
}

impl AddinPermissionsService {
    pub fn new(local_stats: Arc<UserStatsService>) -> Self {
        Self { local_stats }
    }
